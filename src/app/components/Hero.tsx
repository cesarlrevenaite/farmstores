    ...
    <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
        ...
        <motion.h1 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1617713965103-9fda56c89fad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25jcmV0ZSUyMHRleHR1cmV8ZW58MXx8fHwxNzc1MDY4ODczfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')",
