      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border-t-8 border-red-600">
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              <h2 className="font-['Oswald',sans-serif] text-2xl font-bold uppercase tracking-wide text-black mb-4">Other Information</h2>
              <p>
            ...
            <section>
              <h2 className="font-['Oswald',sans-serif] text-2xl font-bold uppercase tracking-wide text-black mb-4">Log Files</h2>
              <p>
            ...
            <section>
              <h2 className="font-['Oswald',sans-serif] text-2xl font-bold uppercase tracking-wide text-black mb-4">Sharing</h2>
              <p>
                We will share aggregated demographic information with our partners and advertisers. This is not linked to any personal information that can identify any individual person. Farm Stores may use your profile information to create personalized content, offers, services, and advertising, but this information will only be used by Farm Stores and its affiliates. Farm Stores and its affiliates may release information when required to do so by law (for example, under a subpoena, court order, or other regulatory requirement).
              </p>
            </section>
            ...
            <section>
              <h2 className="font-['Oswald',sans-serif] text-2xl font-bold uppercase tracking-wide text-black mb-4">Links</h2>
              <p>
                Our site may contain links to other sites. Please be aware that Farm Stores is not responsible for the privacy policies of other sites. We encourage our shoppers to be aware when they leave our Web site and to read the privacy statements of each and every Web site that collects personally identifiable information. This privacy policy applies solely to the information collected by our Web site.
              </p>
            </section>

            <section>
              <h2 className="font-['Oswald',sans-serif] text-2xl font-bold uppercase tracking-wide text-black mb-4">Protection of Privacy of Children Younger than 13</h2>
              <p>
                Farm Stores does not target children under the age of 13 and does not expect to sell any of its products or services to children.
              </p>
            </section>

            <section>
              <h2 className="font-['Oswald',sans-serif] text-2xl font-bold uppercase tracking-wide text-black mb-4">Notification of Changes</h2>
              <p>
